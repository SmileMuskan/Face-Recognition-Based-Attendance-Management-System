                ...
                with open('Attendance.csv', 'a') as f:
                    if (name != 'unknown'):
                        ...
                        if buttonReply == QMessageBox.Yes:
                            ...
                            self.Hour_Label.setText('Measuring')
                ...
                with open('Attendance.csv', 'a') as f:
                    if (name != 'unknown'):
                        ...
                        if buttonReply == QMessageBox.Yes:
                            ...
                            self.ElapseHour = (CheckOutTime - CheckInTime)

                            self.Hour_Label.setText("{:.0f}".format(abs(self.ElapseHour.total_seconds() / 60**2)) + 'h')
                            self.Min_Label.setText("{:.0f}".format(abs(self.ElapseHour.total_seconds() / 60)%60) + 'm')
